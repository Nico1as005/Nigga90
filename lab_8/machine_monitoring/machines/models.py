...
class MachineOperator(models.Model):
    ...
    class Meta:
        verbose_name = "Оператор станка"
        verbose_name_plural = "Операторы станков"
...
class MachineSpecification(models.Model):
    machine = models.OneToOneField(Machine, on_delete=models.CASCADE, primary_key=True, verbose_name="Станок")
...
class MachineReading(models.Model):
    ...
    vibration_frequency = models.DecimalField(max_digits=6, decimal_places=2, verbose_name="Частота вибрации")
    power_consumption = models.DecimalField(max_digits=6, decimal_places=2, verbose_name="Потребляемая мощность")
